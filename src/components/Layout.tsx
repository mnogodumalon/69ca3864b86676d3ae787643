...
import { IconAlertCircle, IconArrowBackUp, IconCar, IconFileText, IconLayoutDashboard, IconMenu2 } from '@tabler/icons-react';
...
const APP_TITLE = 'Fahrschule Manager';
...
const navigation = [
  ...
  { name: 'Fahrschüler', href: '/fahrschueler', icon: IconFileText },
  { name: 'Fahrzeuge', href: '/fahrzeuge', icon: IconCar },
  { name: 'Prüfungen', href: '/pruefungen', icon: IconFileText },
  { name: 'Fahrlehrer', href: '/fahrlehrer', icon: IconFileText },
  { name: 'Fahrstunden', href: '/fahrstunden', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Fahrschüler', href: '/gateway/apps/69ca3843ded5938eab2327f3?template=list_page', icon: IconFileText },
  { name: 'Fahrzeuge', href: '/gateway/apps/69ca38442d14580b19bbb885?template=list_page', icon: IconCar },
  { name: 'Prüfungen', href: '/gateway/apps/69ca3845da08db8b979a68c8?template=list_page', icon: IconFileText },
  { name: 'Fahrlehrer', href: '/gateway/apps/69ca383e14f24285902ff59a?template=list_page', icon: IconFileText },
  { name: 'Fahrstunden', href: '/gateway/apps/69ca38443e4e86a47529a3e4?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69ca3843ded5938eab2327f3?template=list_page"
